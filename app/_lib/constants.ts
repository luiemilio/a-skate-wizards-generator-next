...
export const ITEMS: Item[] = [
    {
        name: 'Staff or Wand',
        description:
            'Once a day it doubles the distance, area, size, or effect of a spell you cast.'
    },
    {
        name: 'Skate Key',
        description:
    ...
    },
    {
        name: 'Shield',
        description:
            'Provides +1 Defense when held. PCs may choose to have it shatter in combat to ignore all damage.'
    },
    {
        name: 'Melee Weapon',
        description:
    ...
    {
        name: 'Oil Flask',
        description: 'Viscous lubricant, flammable, and tastes great on salads.'
    },
    ...
    },
    {
        name: 'Ball Bearings',
        description:
            'A pouchful taken from the prototype of a new mega skate wheel design you’ve been messing with.'
    }
];
...
export const BOOTLEG_SPELLS: Item[] = [
    ...
    },
    {
        name: 'Gleam the Cube',
        description:
            'Defy gravity with your board for five minutes, allowing you to skate on walls and ceilings.'
    }
];
...
export const PERMANENT_SPELLS: Item[] = [
    ...
    {
        name: 'Sidewalk',
        description: 'A magical sidewalk appears directly below your board.'
    },
    {
        name: 'Rail',
        description:
            'A magical rail about as long and tall as a picnic table appears below your skateboard.'
    }
];
